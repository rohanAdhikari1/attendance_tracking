...
class _LoginState extends State<Login> {
  ...
  void _login() async {
    if (_formField.currentState!.validate()) {
      ...
      Map<String, dynamic> mRes = await auth.login(
      ...
      if (mRes['type'] == MessageType.success) {
        ...
        switch (mRes['role']) {
          case 'cleaner':
            Get.off(
              () => AppLayout(child: HomePage()),
              preventDuplicates: true,
            );
          case 'admin':
            Get.off(
              () => AppLayout(child: AdminHomePage()),
              preventDuplicates: true,
            );
          case 'super_admin':
            Get.off(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      floatingLabelStyle: TextStyle(color: Colors.amber[900]),
                      ...
                      prefixIcon: Icon(Icons.person, color: Colors.amber[900]),
                    ),
                  ),
                  SizedBox(height: 40),
                  TextFormField(
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: isLoading.value
                          ? SpinKitWave(color: Colors.amber[900], size: 26.0)
                          : Text(
                              'LOGIN',
                              style: TextStyle(
                                color: Colors.white,
